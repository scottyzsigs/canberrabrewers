...
<div class='centerIt'><img src="http://www.canberrabrewers.com.au/wp-content/uploads/2013/01/CB_banner.jpg" border="0" alt="Canberra Brewers Club" /></div>
END;
echo sprintf($header_section,'09-02-2009','09-02-2009','gPHPEdit','Cb entry form','Competition Entry Form','compstyles.css','compjs.js');
...
while ($styles_details=$styles_result->fetch_assoc())
{
		...
		$styles_buf .='<td>' . $sub_style_name .":&nbsp;</td><td><input type='checkbox' name='check_".$full_style ."' onclick=\"toggleDisplay(this)\" /></td>"; 
...
%s
<br />
<form id='check_only_form' name='check_only_form' method='POST' action='submit_entries.php' >
...
<div class='centerIt' >
	<img id='submitImage' style='text-align: center; cursor: pointer; display: none ' src='submit.jpg' title='Submit your entry' alt='Submit your entry' onclick='checkData()' />
</div>
